...
<br />
O objetivo dos exercícios é  fazer queries mais complexas no BD usando comandos como WHERE, LIKE, BETWEEN, entre outros. Os comandos para resolução dos exercícios estão no arquivo resolution.sql
